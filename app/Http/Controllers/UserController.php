...
class UserController extends Controller
{
    ...
    public function edit($Codigo)
    {
        ...
        return view("usuarios.persona.editar_perfil", compact('validated', 'rols'));
    }
    ...
    public function updateConfiguraciones(Request $request)
    {
        ...
        $us = User::where('usuario.email', $request->email)
            ->first();
        ...
        Session::flash('messagedel', '¡Se guardaron las configuraciones satisfactoriamente!');
        return redirect('usuarios.persona.editar_perfil');
    }
