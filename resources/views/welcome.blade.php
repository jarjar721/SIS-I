              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="login.html"><i class="fas fa-sign-out-alt pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <span class="count_bottom"><i class="green"><i class="fas fa-sort-up"></i>3% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Males</span>
              <div class="count green">2,500</div>
              <span class="count_bottom"><i class="green"><i class="fas fa-sort-up"></i>34% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Females</span>
              <div class="count">4,567</div>
              <span class="count_bottom"><i class="red"><i class="fas fa-sort-down"></i>12% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      ...
                      <li><i class="fas fa-chart-bar"></i><a href="#">Auto Renewal</a> </li>
                      <li><i class="fas fa-chart-line"></i><a href="#">Achievements</a>
                      </li>
                      <li><i class="fas fa-chart-bar"></i><a href="#">Auto Renewal</a> </li>
                      <li><i class="fas fa-chart-line"></i><a href="#">Achievements</a>
                      </li>
                      <li><i class="fas fa-chart-area"></i><a href="#">Logout</a>
                      </li>
                    </ul>
